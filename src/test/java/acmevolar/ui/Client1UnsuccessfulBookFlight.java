...
public class Client1UnsuccessfulBookFlight {
  ...
  public void testClientUnsuccessfulBookFlight() throws Exception {
    ...
    assertEquals("There are only 248 seats in this flight!", driver.findElement(By.xpath("//form[@id='add-book-form']/div/div/div/span[2]")).getText());
    driver.findElement(By.id("quantity")).click();
    driver.findElement(By.id("quantity")).clear();

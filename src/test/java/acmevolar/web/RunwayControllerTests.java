...
class RunwayControllerTests {
	...
	void setup() {
		...
		runway1.setId(1);
		given(this.runwayService.findRunwayTypeById(RunwayControllerTests.TEST_RUNWAY_TAKE_OFF_ID1))
				.willReturn(runway1);
		...
		runway2.setId(2);
		given(this.runwayService.findRunwayTypeById(RunwayControllerTests.TEST_RUNWAY_LANDING_ID2))
				.willReturn(new RunwayType());

...
<petclinic:layout pageName="airlines">
			...
			<c:forEach items="${airlines}" var="airline">
				<tr>
					<td><spring:url value="/airlines/{airlineId}" var="airlineUrl">
						...
						</spring:url> <a href="${fn:escapeXml(airlineUrl)}"><c:out value="${airline.name}" /></a></td>
	...
	<sec:authorize access="hasAuthority('airline')">
		<button class="btn btn-default" onclick="window.location.href='/airlines/new'">New</button>
	</sec:authorize>
